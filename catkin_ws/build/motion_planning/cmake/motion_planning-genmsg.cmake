...
message(STATUS "motion_planning: 0 messages, 1 services")
...
get_filename_component(_filename "/home/pi/Projects/ROS_Quadruped/catkin_ws/src/motion_planning/srv/Direction.srv" NAME_WE)
add_custom_target(_motion_planning_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "motion_planning" "/home/pi/Projects/ROS_Quadruped/catkin_ws/src/motion_planning/srv/Direction.srv" ""
)
...
### Generating Services
_generate_srv_cpp(motion_planning
  "/home/pi/Projects/ROS_Quadruped/catkin_ws/src/motion_planning/srv/Direction.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_eus(motion_planning
  "/home/pi/Projects/ROS_Quadruped/catkin_ws/src/motion_planning/srv/Direction.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_lisp(motion_planning
  "/home/pi/Projects/ROS_Quadruped/catkin_ws/src/motion_planning/srv/Direction.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_nodejs(motion_planning
  "/home/pi/Projects/ROS_Quadruped/catkin_ws/src/motion_planning/srv/Direction.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_py(motion_planning
  "/home/pi/Projects/ROS_Quadruped/catkin_ws/src/motion_planning/srv/Direction.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motion_planning)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motion_planning\")")
  # install generated code
  install(
